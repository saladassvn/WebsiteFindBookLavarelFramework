                        ...
                        <div class="footer__dowload">                       
                            ...
                            <div class="footer__download-apps">
                                <a href="" class="footer__dowload-app-link">                               
                                    <img src="{{('public/User/img/google_play.png')}}" alt="Google play" class="footer__dowload-app-img">
                                </a>
                                <a href="" class="footer__dowload-app-link">                               
                                    <img src="{{('public/User/img/app_store.png')}}" alt="App store" class="footer__dowload-app-img">
                                </a>
                            </div>
                        </div>
                    </div>  
